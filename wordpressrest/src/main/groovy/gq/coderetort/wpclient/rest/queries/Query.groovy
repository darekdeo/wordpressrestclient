...
class Query {
     ...
     */
    @JsonProperty("status") List<String> statusList
     ...
     */
    @JsonProperty("parent") List<Integer> parentList

    /**
     * Ensure result set excludes specific parent ids.
     */
    @JsonProperty("parent_exclude") List<Integer> parentExcludeList
     ...
     */
    @JsonProperty("post") List<Integer> postList
